...
\title{\vspace{-1.5em}Adaptive First-Order Methods for Logistic Objectives and Non-Convex Reference Landscapes}
\author{Erion Krasniqi \and Denis Mustafa Xhabrahimi\\
University of Basel\\
...
\begin{equation}
    v_t=\rho v_{t-1}+(1-\rho)g_t\odot g_t,\qquad
...
\begin{figure}[t]
    ...
    \end{subfigure}
    \vspace{-0.4em}
    \caption{On convex A9a logistic regression, adaptive methods reduce training loss faster than SGD, while all methods reach similar final test accuracy.}
    \label{fig:a9a}
\end{figure}
...
\begin{figure}[t]
    ...
    \begin{subfigure}{0.48\linewidth}
        ...
        \caption{A9a non-convex regularized loss.}
    \end{subfigure}
    \begin{subfigure}{0.48\linewidth}
        \includegraphics[width=\linewidth]{figures/a9a_nonconvex_acc.png}
        \caption{A9a non-convex test accuracy.}
    \end{subfigure}
    \vspace{-0.4em}
    \caption{The non-convex regularizer raises the final objective value, but at $\lambda=10^{-2}$ it has little effect on the optimizer ranking or test accuracy.}
    \label{fig:a9a-nc}
\end{figure}
...
Adding the non-convex regularizer increases the final objective value (Figure~\ref{fig:a9a-nc}). The ranking remains similar and accuracies remain near $84$--$85\%$. Thus, for the chosen moderate regularization strength, the required non-convex objective does not create a landscape where Adam's advantage is visually dominant.
...
\begin{figure}[t]
    ...
    \begin{subfigure}{0.48\linewidth}
        ...
        \caption{A9a loss against wall-clock time.}
    \end{subfigure}
    \begin{subfigure}{0.48\linewidth}
        \includegraphics[width=\linewidth]{figures/wallclock_mnist.png}
        \caption{MNIST loss against wall-clock time.}
    \end{subfigure}
    \vspace{-0.4em}
...
\begin{figure}[t]
    ...
    \begin{subfigure}{0.48\linewidth}
        ...
        \caption{Learning-rate sensitivity on A9a.}
    \end{subfigure}
    \begin{subfigure}{0.48\linewidth}
        \includegraphics[width=\linewidth]{figures/lambda_sweep.png}
        \caption{Non-convex regularization strength.}
    \end{subfigure}
    \vspace{-0.4em}
...
\begin{figure}[t]
    ...
    \begin{subfigure}{0.48\linewidth}
        ...
        \caption{Rosenbrock trajectories, final animation frame.}
    \end{subfigure}
    \vspace{-0.4em}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.88\linewidth]{figures/lbfgs_reference.png}
